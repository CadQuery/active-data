...
function (ACTDATA_RETRIEVE_VERSION VERSION_FILE MAJOR MINOR PATCH)
  ...
  foreach (line ${VERSION_FILE_DATA})
    string(REGEX MATCH "ACT_VERSION_MAJOR *[0-9]" match ${line})
    ...
    string(REGEX MATCH "ACT_VERSION_MINOR *[0-9]" match ${line})
    if (NOT "${match}" STREQUAL "")
      separate_arguments(match)
      list(GET match 1 num)
    ...
    string(REGEX MATCH "ACT_VERSION_PATCH *[0-9]" match ${line})
    if (NOT "${match}" STREQUAL "")
      separate_arguments(match)
      list(GET match 1 num)
